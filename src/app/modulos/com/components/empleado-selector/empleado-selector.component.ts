...
import { AutocompleteModule } from '../../../com/components/autocomplete/autocomplete.component';

@Component({
    selector: 'sm-empleadoSelector',
...
@NgModule({
    imports: [CommonModule, TreeModule, IonicModule, AutocompleteModule, FormsModule],
    exports: [EmpleadoSelectorComponent],
