...
var ConsultaTareasPage = /** @class */ (function () {
    ...
    ConsultaTareasPage.prototype.ngOnInit = function () {
        ...
        this.tareaService.findByFilter(fq).then(function (resp) {
            _this.tareasList = [];
    ...
    ConsultaTareasPage.prototype.confirmarTarea = function (tarea, idx, repCump) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        accion = repCump ? 'cumplimiento' : 'verificación';
                        return [4 /*yield*/, this.alertController.create({
                                ...
                                buttons: [
                                    {
                                        text: 'Ok',
                                        handler: function (data) { return _this.reportar(tarea, repCump, idx, data.descripcion); }
                                    },
                                    {
                                        text: 'Cancel',
                                        role: 'cancel',
    ...
    ConsultaTareasPage.prototype.reportar = function (tarea, repCump, idx, descripcion) {
        var _this = this;
        if (repCump == true) {
            tarea.observacionesRealizacion = descripcion;
            ...
            tarea.observacionesVerificacion = descripcion;
